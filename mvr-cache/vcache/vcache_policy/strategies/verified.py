...
class VerifiedDecisionPolicy(VCachePolicy):
    ...
    def __init__(self, delta: float = 0.01, timing_collector=None):
        """
        ...
        # Used by benchmarks to measure embedding/retrieval overhead with minimal runtime cost.
    ...
    def process_request(
        ...
        # Separate embedding + retrieval so benchmarks can time them independently.
        ...
        if not knn:
            ...
            # Keep correctness identical to Cache.add (embedding + insert); do not time inserts here.
